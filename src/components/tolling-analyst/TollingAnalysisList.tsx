        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>View and manage your past tolling analyses</CardDescription>
            </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mt-1">Upload a tolling agreement to get started</p>
            </div>
          ) : (
            <Table>
              <TableHeader>
                  ...
                  <TableRow key={analysis.id} className="cursor-pointer hover:bg-muted/50">
                    ...
                    <TableCell onClick={() => setSelectedAnalysisId(analysis.id)}>
                      <Badge variant="outline">
                        {analysis.analysis_type === 'tolling_vs_bible' ? 'vs Knowledge' : 'vs Term Sheet'}
                      </Badge>
                    </TableCell>
                    <TableCell onClick={() => setSelectedAnalysisId(analysis.id)}>
                    ...
                    <TableCell onClick={() => setSelectedAnalysisId(analysis.id)}>
                      <Badge variant="secondary">
                        {analysis.perspective === 'offtaker' ? 'Offtaker' : 'Generator'}
                      </Badge>
                    </TableCell>
                    <TableCell onClick={() => setSelectedAnalysisId(analysis.id)}>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem className="text-destructive" onClick={() => setDeleteConfirmId(analysis.id)}>

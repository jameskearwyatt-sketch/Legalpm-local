...
import { 
  ...
  ColumnRenderContext, 
  HeaderRenderContext,
  SortField as ColumnSortField 
} from '@/components/matters/tableColumnDefinitions';
                  ...
                  <TableHeader>
                    <TableRow className="hover:bg-transparent">
                      {(() => {
                        ...
                        const headerCtx: HeaderRenderContext = {
                          toggleSort,
                          sortField,
                          sortDirection,
                        };
                      ...
                      return (
                        <TableRow key={matter.id} className="group">
                          {orderedColumns.map((col) => {
                            const cellClassName = typeof col.cellClassName === 'function' 
                              ? col.cellClassName(cellCtx) 
                              : col.cellClassName;
                            return (
                              <TableCell key={col.id} className={cellClassName}>

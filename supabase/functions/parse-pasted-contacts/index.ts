...
2. Names may appear in various formats - ALWAYS output names in "FirstName Surname" format (natural reading order):
...
OUTPUT FORMAT: Return valid JSON with an array of contacts. Each contact must have at minimum an email. Names MUST be in "FirstName Surname" format (e.g., "John Smith", NOT "Smith, John").`;
                  ...
                  contacts: {
                    ...
                    items: {
                      ...
                      properties: {
                        full_name: { 
                          type: 'string', 
                          description: 'Full name in "FirstName Surname" format (e.g., "John Smith"). Natural reading order, no comma.' 
                        },
                        email: { 
                          type: 'string', 
